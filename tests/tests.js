...
testJson('./CrystalMaltSpecialtyGrain.json')
testJson('./IrishMoss.json')
testJson('./CorianderSpice.json')
testJson('./HopWithRequiredFieldsOnly.json')
testJson('./HopRecordWithAllFields.json')
